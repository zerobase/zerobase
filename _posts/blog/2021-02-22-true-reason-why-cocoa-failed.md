...
ですから、これは倫理上の失敗であり、政治的な失敗なのです。これをITの失敗とみなすのは、あまりに表層的な理解だと言わざるを得ません。
...
専門家には「上から降ってきた命令を何とかする」という思考が染み付いているのかもしれません。しかし、その命令が正しいかどうかを常に問わなければなりません。命令の倫理的正当性を問わずに粛々とこなすアイヒマンになってはいけません[^16]。良心と良識から、異議を申し立てるべきです。それが専門家の職業倫理というものです。

## バグのないゴミアプリ

いま日本政府はCOCOAのバグ（不具合）を解消すべく体制を立て直そうとしています。しかし、単にバグを解消したところで、まったく無意味です。それでは「バグだらけのゴミ」であるCOCOAが、単に「バグのないゴミ」になるだけです。
...
「一体何度失敗すれば気が済むのか」と国民もうんざりするでしょう。いよいよ政府・厚労省・デジタル庁の信頼も地に落ちます。政治家は責任を取らないでしょうし。
...
科学的に有効なシステムにしていくため、必要なデータを収集し、エビデンスを集めながら、感染制御のためのフィードバックシステムとしてチューニングし続けていくべきです。そのために法改正等が必要なら実施すべきです。英国[^17]、ドイツ[^18]、スイス[^19]、カナダ[^20]などの取り組みを参考に。
...
あくまでも、科学的に合理的な、コストとベネフィットが釣り合うような手段によって、感染が抑制されなければなりません。

そして、まさにそういう効果検証とチューニングのために、諸外国は様々な工夫をしているわけです。一方、本邦ではそのような工夫が見られない。まったくもって論外です。接触確認アプリを運用する資格がないと言わざるをえません。
...
僕は絶望しています。問題を論理的に分析すれば、絶望せざるをえません。みなさんも絶望すべきです。
...
『失敗の本質 日本軍の組織論的研究』という名著があるのに、同じ失敗を繰り返す日本社会とは何でしょうか[^21]。「失敗の本質」を読んでも理解できないか、理解できても実践を変えられない。それは認識がおかしいからです。変えるべきは認識です。江戸時代的な物の見方と考え方を、近代化しなければなりません[^22]。

## 認識の問題

大きな枠組みから考えてみましょう[^23]。認識論（物の見方や考え方）から科学が作られ、科学から実践が作られます。それぞれ、認識論はメタレベル、科学はオブジェクト・レベル、実践は応用レベルに属します。
...
そして、日本にはそれができないと確信できてしまうことに、僕は絶望しています。戦争に敗ける認識論を捨てない限り、何をやってもダメなのですから。みなさんも、この認識に到達してほしいと思います。細かい議論は、そのあとの話です。

結局、この文章で問題にしてきたのは、「どうすればCOCOAを上手くやれたか」という問いと、「どうすればCOCOAをうまくやれる政府を作れたか」という問いとの違いです。みな前者ばかり問題にしているけれど、それは本質的な問いではない。それを理解してほしいのです。
...
厚生労働省は4月16日付でCOCOA不具合調査・再発防止策検討チームの報告書を公表しました[^30]。しかし、その内容は「失敗の本質」を捉えそこねたものでした。
